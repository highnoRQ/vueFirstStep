let routesTable,clearConsole,done,hasYarn,chalk;_7d8‍.x([["default",()=>_7d8‍.o]]);_7d8‍.w("./routeTable",[["default",["routesTable"],function(v){routesTable=v}]]);_7d8‍.w("@vue/cli-shared-utils",[["clearConsole",["clearConsole"],function(v){clearConsole=v}],["done",["done"],function(v){done=v}],["hasYarn",["hasYarn"],function(v){hasYarn=v}]]);_7d8‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);



const _7d8‍anonymous=({ urls, routes, isInProduction, shouldServeApp }) => {
  ...
  if (routes.length) {
    ...
    _7d8‍.g.console.log(routesTable(routes));
  } else {
